...
function initIcons() {
    let src = ['pic/?path=icons/WhiteKing.png', 'pic/?path=icons/BlackKing.png', 'pic/?path=icons/WhitePawn.png', 'pic/?path=icons/BlackPawn.png', 'pic/?path=icons/WhiteQueen.png', 'pic/?path=icons/BlackQueen.png', 'pic/?path=icons/WhiteKnight.png', 'pic/?path=icons/BlackKnight.png', 'pic/?path=icons/WhiteBishop.png', 'pic/?path=icons/BlackBishop.png', 'pic/?path=icons/WhiteRook.png', 'pic/?path=icons/BlackRook.png'];
